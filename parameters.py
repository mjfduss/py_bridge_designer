...
class Material():
    def __init__(self,
        ...
        # Cost in dollars per cm^3 by section [Bar, Tube]
        self.cost = cost
...
class Params():
    def __init__(self) -> None:
        # The least illegal slenderness value.
        self.slenderness_limit = 300.0
        ...
        # Cost of connecting members at a joint
        self.connection_cost = 400.0
        ...
        # Number of sizes available by section.
        self.n_sizes = [N_BAR_SIZES, N_TUBE_SIZES]
                ...
                if section_index == Bar:
                    ...
                    sections.append(
                        Shape(name=f"{width}x{width}x{tube_thickness}",
                              width=width,
                              area=(_sqr(width) - _sqr(width -
                                    2 * tube_thickness)) * 1e-6,
